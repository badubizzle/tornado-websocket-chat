...
function chatWithUserInvite(chatuser, data){
	console.log("starting chat from invite "+chatuser);
	console.log('chat data: '+data);
	createChatBox(chatuser);
	$("#chatbox_"+chatuser+" .chatboxtextarea").focus();
	$("#chatbox_"+chatuser).find("div.chatboxtitle").text(chatuser+" online");
	$("#chatbox_"+chatuser).data('chatdata',data);
	var session_key=data["sessionkey"];
	$("#chatbox_"+chatuser).attr('sessionkey',session_key);
}
function chatWith(chatuser) {
	console.log("starting chat with user: "+chatuser);
	start_session(chatuser);
	createChatBox(chatuser);
	$("#chatbox_"+chatuser+" .chatboxtextarea").focus();
...
function closeAllChats(){
	$.each($("div.chatbox"),function(i,elem){
